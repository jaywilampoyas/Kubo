...
<div class="container">
  <h3 style="font-weight: bold; text-align: center;">Tenant Registration</h3><hr><br>
  <form method="POST" action="tenant-engine.php" enctype="multipart/form-data">
    ...
    <div class="form-group text-right">
      <label class="">Register as a <a class="ownerregistration" href="owner-register.php">Owner</a>?</label><br>
    </div><br><br>
  </form>
</div>
