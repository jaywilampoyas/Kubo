...
<div class="containerviewproperty">
  <div class="row">
    <div class="col-sm-6">
...
<div class="col-sm-6">
  ...
  <div class="row">
      ...
      <div class="col-sm-6">
          <table>
            ...
            <tr>
              ...
              <td><h4><?php echo $rows['property_type']; ?></h4></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><h3>Total No. of Rooms:</h3></td>
              <td><h4><?php echo $rows['total_rooms']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>No. of Bedroom:</h3></td>
              <td><h4><?php echo $rows['bedroom']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>No. of Living Room::</h3></td>
              <td><h4><?php echo $rows['living_rooms']; ?></h4></td>
            </tr>-
          </table>
        </div>
      </div>
    ...
    <div class="col-sm-6">
      <table>
            <tr>
              <td><h3>No. of Kitchen:</h3></td>
              <td><h4><?php echo $rows['kitchen']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>No. of Bathroom/Washroom::</h3></td>
              <td><h4><?php echo $rows['bathroom']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>Type of Furnish:</h3></td>
              <td><h4><?php echo $rows['furnish']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>Land Size:</h3></td>
              <td><h4><?php echo $rows['landsize']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>Floor Area:</h3></td>
              <td><h4><?php echo $rows['floorarea']; ?></h4></td>
            </tr>
            <tr>
              <td><h3>Booked:</h3></td>
...
<div class="containerviewproperty">
  <h2>Review Property:</h2>
      <div class="well well-sm" id="review">
            <div class="text-right">
<?php 
      
if(isset($_SESSION["email"]) && !empty($_SESSION['email'])){
?>
                <a class="btn btn-success btn-info" href="#reviews-anchor" style="width: 100%" id="open-review-box"><span class="revbtn">Leave a Review</span></a>
            </div>
...
echo '<div class="containerviewproperty">';
    echo '<h3>Reviews:</h3>';
    echo '</div>';
  if(mysqli_num_rows($query)>0)
