...
function add_property(){
	...
	global $property_id,$country,$city,$address,$contact_no,$property_type,$estimated_price,$total_rooms,$bedroom,$living_rooms,$kitchen,$bathroom,$furnish,$landsize,$floorarea,$description,$owner_id,$booked,$db;
	...
	$living_rooms=validate($_POST['living_rooms']);
	$kitchen=validate($_POST['kitchen']);
	$bathroom=validate($_POST['bathroom']);
	$furnish=validate($_POST['furnish']);
	$landsize=validate($_POST['landsize']);
	...
	$description=validate($_POST['description']);
        ...
        if(mysqli_num_rows($result1)>0)
      {
   	...
   	$sql = "INSERT INTO add_property(country,city,address,contact_no,property_type,estimated_price,total_rooms,bedroom,living_rooms,kitchen,bathroom,furnish,landsize,floorarea,description,booked,owner_id) VALUES('$country','$city','$address','$contact_no','$property_type','$estimated_price','$total_rooms','$bedroom','$living_rooms','$kitchen','$bathroom','$furnish','$landsize','$floorarea','$description','$booked','$owner_id')";
