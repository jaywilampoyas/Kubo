...
<?php
      ...
      <li class="register"><a class="registerbutton" href="how-to-register.php"><span class="glyphicon glyphicon-user" id="registerlogo"></span>Register</a></li>
      <li class="login"><a class="loginbutton" href="how-to-login.php"><span class="glyphicon glyphicon-log-in" id="loginlogo"></span> Login</a></li>
    <?php } ?>
    </ul>
  </div>
</nav>
