...
<div class="container">
  <h3 style="font-weight: bold; text-align: center;">Owner Registration</h3><hr><br>
  <form method="POST" action="owner-engine.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="card_photo">Upload a picture for your profile:</label>
    ...
    <div class="form-group text-right">
      <label class="">Register as a <a class="tenantregistration" href="tenant-register.php">Tenant</a>?</label><br>
    </div><br><br>
  </form>
</div>
